...
type AlertingPush struct {
	...
	// Types that are valid to be assigned to Badge:
	//	*AlertingPush_BadgeValue
	Badge isAlertingPush_Badge `protobuf_oneof:"badge"`
}
...
type isAlertingPush_Badge interface {
	isAlertingPush_Badge()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}
...
type AlertingPush_BadgeValue struct {
	BadgeValue int32 `protobuf:"varint,6,opt,name=badge_value,json=badgeValue,proto3,oneof"`
}
...
func (*AlertingPush_BadgeValue) isAlertingPush_Badge()            {}
...
func (m *AlertingPush) GetBadge() isAlertingPush_Badge {
	if m != nil {
		return m.Badge
	}
	return nil
...
func (m *AlertingPush) GetBadgeValue() int32 {
	if x, ok := m.GetBadge().(*AlertingPush_BadgeValue); ok {
		return x.BadgeValue
	}
	return 0
}
...
func _AlertingPush_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	// badge
	switch x := m.Badge.(type) {
	case *AlertingPush_BadgeValue:
		_ = b.EncodeVarint(6<<3 | proto.WireVarint)
		_ = b.EncodeVarint(uint64(x.BadgeValue))
	case nil:
	default:
		return fmt.Errorf("AlertingPush.Badge has unexpected type %T", x)
	}
	return nil
}
...
func _AlertingPush_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // alert_title.simple_alert_title
		...
		return true, err
	case 6: // badge.badge_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.Badge = &AlertingPush_BadgeValue{int32(x)}
		return true, err
	default:
		return false, nil
	}
...
func _AlertingPush_OneofSizer(msg proto.Message) (n int) {
	...
	case *AlertingPush_BadgeValue:
		...
		n += proto.SizeVarint(uint64(x.BadgeValue))
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
	}
...
func (this *AlertingPush) Equal(that interface{}) bool {
	...
	} else if this.Badge == nil {
		return false
	} else if !this.Badge.Equal(that1.Badge) {
		return false
	}
	return true
}
...
func (this *AlertingPush_BadgeValue) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*AlertingPush_BadgeValue)
	if !ok {
		that2, ok := that.(AlertingPush_BadgeValue)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.BadgeValue != that1.BadgeValue {
		return false
	}
	return true
}
...
func (this *AlertingPush_BadgeValue) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&main.AlertingPush_BadgeValue{` +
		`BadgeValue:` + fmt.Sprintf("%#v", this.BadgeValue) + `}`}, ", ")
	return s
}
...
func (m *AlertingPush) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Badge != nil {
		nn3, err := m.Badge.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn3
...
func (m *AlertingPush_LocAlertBody) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LocAlertBody != nil {
		...
		n4, err := m.LocAlertBody.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *AlertingPush_LocAlertTitle) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LocAlertTitle != nil {
		...
		n5, err := m.LocAlertTitle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *AlertingPush_BadgeValue) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	dAtA[i] = 0x30
	i++
	i = encodeVarintPushService(dAtA, i, uint64(m.BadgeValue))
	return i, nil
}
...
func (m *EncryptedPush) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PublicAlertingPush != nil {
		...
		n6, err := m.PublicAlertingPush.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *PushBody_SilentPush) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SilentPush != nil {
		...
		n8, err := m.SilentPush.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *PushBody_AlertingPush) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AlertingPush != nil {
		...
		n9, err := m.AlertingPush.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *PushBody_VoipPush) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.VoipPush != nil {
		...
		n10, err := m.VoipPush.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *PushBody_EncryptedPush) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EncryptedPush != nil {
		...
		n11, err := m.EncryptedPush.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *AlertingPush_BadgeValue) Size() (n int) {
	var l int
	_ = l
	n += 1 + sovPushService(uint64(m.BadgeValue))
	return n
}
...
func (this *AlertingPush_BadgeValue) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AlertingPush_BadgeValue{`,
		`BadgeValue:` + fmt.Sprintf("%v", this.BadgeValue) + `,`,
		`}`,
	}, "")
	return s
...
func (m *AlertingPush) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BadgeValue", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Badge = &AlertingPush_BadgeValue{v}
		default:
			iNdEx = preIndex
			skippy, err := skipPushService(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorPushService = []byte{
	...
	,
}
